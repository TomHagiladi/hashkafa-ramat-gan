...
export default function Hero() {
  return (
    <header className="relative overflow-hidden bg-abyss">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 pt-8 pb-56 md:pt-14 md:pb-72">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-56 md:h-64 bg-gradient-to-t from-abyss via-abyss/85 to-transparent" />
        <div className="relative flex justify-center pb-2 md:pb-3">
          <Image
            ...
            height={460}
            priority
            className="w-[75%] sm:w-[55%] md:w-[40%] lg:w-[34%] max-w-[440px] h-auto opacity-90"
          />
        </div>
      </div>
    </header>
